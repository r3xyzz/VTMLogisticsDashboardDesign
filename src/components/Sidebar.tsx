...
const navItems: NavItem[] = [
  ...
  { id: 'fleet',     label: 'Flota · Vehículos' },      //  Separar vehículos
  { id: 'drivers',   label: 'Conductores' },            //  Agregar conductores
...
function NavIcon({ id }: { id: ActiveView }) {
  const d: Record<ActiveView, string | string[]> = {
    ...
    drivers:   'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', //  Agregar ícono de conductores
  }
